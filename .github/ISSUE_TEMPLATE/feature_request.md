...
about: Suggest a new feature or enhancement for the FastPix Ruby SDK
title: '[FEATURE] '
...
Thank you for suggesting a new feature for the FastPix Ruby SDK! Please provide the following information to help us understand and evaluate your request:
...
```
<!-- How do other Ruby SDKs handle this? -->
```
## Priority
