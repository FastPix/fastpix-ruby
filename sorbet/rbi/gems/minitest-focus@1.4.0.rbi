...
class Minitest::Test < ::Minitest::Runnable
  # source://minitest/5.25.2/lib/minitest/test.rb#189
  def capture_exceptions; end

  # source://minitest/5.25.2/lib/minitest/test.rb#15
  def class_name; end

  # source://minitest/5.25.2/lib/minitest/test.rb#206
  def neuter_exception(e); end

  # source://minitest/5.25.2/lib/minitest/test.rb#217
  def new_exception(klass, msg, bt, kill = T.unsafe(nil)); end

  # source://minitest/5.25.2/lib/minitest/test.rb#87
  def run; end

  # source://minitest/5.25.2/lib/minitest/test.rb#199
  ...
  class << self
    ...
    # source://minitest/5.25.2/lib/minitest/test.rb#35
    def i_suck_and_my_tests_are_order_dependent!; end

    # source://minitest/5.25.2/lib/minitest/test.rb#26
    def io_lock; end

    # source://minitest/5.25.2/lib/minitest/test.rb#26
    def io_lock=(_arg0); end

    # source://minitest/5.25.2/lib/minitest/test.rb#48
    def make_my_diffs_pretty!; end

    # source://minitest/5.25.2/lib/minitest/test.rb#60
    def parallelize_me!; end

    # source://minitest/5.25.2/lib/minitest/test.rb#70
