...
| `data`                                                                                     | [T.nilable(Models::Components::CreatePlaybackId)](../../models/components/createplaybackid.md) | :heavy_minus_sign:                                                                         | A collection of Playback ID objects utilized for crafting HLS playback urls.               |                                                                                            |