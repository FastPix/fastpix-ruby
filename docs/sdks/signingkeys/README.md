...
<!-- UsageSnippet language="ruby" operationID="create_signing_key" method="post" path="/iam/signing-keys" -->
```ruby
require 'fastpixapi'
...
res = s.signing_keys.create_signing_key()

unless res.create_response.nil?
  # handle response
end
...
**[T.nilable(Models::Operations::CreateSigningKeyResponse)](../../models/operations/createsigningkeyresponse.md)**

### Errors

| Error Type                                | Status Code                               | Content Type                              |
| ----------------------------------------- | ----------------------------------------- | ----------------------------------------- |
| Models::Errors::UnAuthorizedResponseError | 401                                       | application/json                          |
| Models::Errors::ForbiddenResponseError    | 403                                       | application/json                          |
...
<!-- UsageSnippet language="ruby" operationID="list_signing_keys" method="get" path="/iam/signing-keys" -->
```ruby
require 'fastpixapi'
...
res = s.signing_keys.list_signing_keys(limit: 25.0, offset: 1.0)

unless res.get_all_signing_key_response.nil?
  # handle response
end
...
**[T.nilable(Models::Operations::ListSigningKeysResponse)](../../models/operations/listsigningkeysresponse.md)**
...
<!-- UsageSnippet language="ruby" operationID="delete_signing_key" method="delete" path="/iam/signing-keys/{signingKeyId}" -->
```ruby
require 'fastpixapi'
...
res = s.signing_keys.delete_signing_key(signing_key_id: '3ta85f64-5717-4562-b3fc-2c963f66afa6')

unless res.delete_signing_key_response.nil?
  # handle response
end
...
| Parameter                                                                                                               | Type                                                                                                                    | Required                                                                                                                | Description                                                                                                             | Example                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `signing_key_id`                                                                                                        | *::String*                                                                                                              | :heavy_check_mark:                                                                                                      | When creating the signing key, FastPix assigns a universally unique identifier with a maximum length of 255 characters. | 3ta85f64-5717-4562-b3fc-2c963f66afa6                                                                                    |

### Response

**[T.nilable(Models::Operations::DeleteSigningKeyResponse)](../../models/operations/deletesigningkeyresponse.md)**
...
| Models::Errors::UnAuthorizedResponseError | 401                                       | application/json                          |
| Models::Errors::ForbiddenResponseError    | 403                                       | application/json                          |
| Models::Errors::SigningKeyNotFoundError   | 404                                       | application/json                          |
| Models::Errors::ValidationErrorResponse   | 422                                       | application/json                          |
| Errors::APIError                          | 4XX, 5XX                                  | \*/\*                                     |
...
<!-- UsageSnippet language="ruby" operationID="get-signing_key_by_id" method="get" path="/iam/signing-keys/{signingKeyId}" -->
```ruby
require 'fastpixapi'
...
res = s.signing_keys.get_signing_key_by_id(signing_key_id: '5ta85f64-5717-4562-b3fc-2c963f66afa6')

unless res.get_public_pem_using_signing_key_id_response_dto.nil?
  # handle response
end
...
| Parameter                                                                                                                | Type                                                                                                                     | Required                                                                                                                 | Description                                                                                                              | Example                                                                                                                  |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| `signing_key_id`                                                                                                         | *::String*                                                                                                               | :heavy_check_mark:                                                                                                       | When creating the signing key, FastPix assigns a universally unique identifier with a maximum length of 255 characters.  | 5ta85f64-5717-4562-b3fc-2c963f66afa6                                                                                     |

### Response

**[T.nilable(Models::Operations::GetSigningKeyByIdResponse)](../../models/operations/getsigningkeybyidresponse.md)**
