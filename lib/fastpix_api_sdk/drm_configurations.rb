...
module FastpixApiSDK
  ...
  class DRMConfigurations
    ...
    sig { params(offset: T.nilable(::Integer), limit: T.nilable(::Integer), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetDrmConfigurationResponse) }
    def get_drm_configuration(offset: nil, limit: nil, retries: nil, timeout_ms: nil)
    ...
    sig { params(drm_configuration_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetDrmConfigurationByIdResponse) }
    def get_drm_configuration_by_id(drm_configuration_id:, retries: nil, timeout_ms: nil)
