...
module FastpixApiSDK
  ...
  class SimulcastStream
    ...
    sig { params(simulcast_request: Models::Components::SimulcastRequest, stream_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::CreateSimulcastOfStreamResponse) }
    def create_simulcast_of_stream(simulcast_request:, stream_id:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['201'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::CreateSimulcastOfStreamResponse.new(
            ...
            simulcast_response: T.unsafe(obj)
          )
    ...
    sig { params(stream_id: ::String, simulcast_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::DeleteSimulcastOfStreamResponse) }
    def delete_simulcast_of_stream(stream_id:, simulcast_id:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::DeleteSimulcastOfStreamResponse.new(
            ...
            content_type: content_type,
            raw_response: http_response,
            simulcastdelete_response: T.unsafe(obj)
          )
    ...
    sig { params(stream_id: ::String, simulcast_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetSpecificSimulcastOfStreamResponse) }
    def get_specific_simulcast_of_stream(stream_id:, simulcast_id:, retries: nil, timeout_ms: nil)
    ...
    sig { params(simulcast_update_request: Models::Components::SimulcastUpdateRequest, stream_id: ::String, simulcast_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::UpdateSpecificSimulcastOfStreamResponse) }
    def update_specific_simulcast_of_stream(simulcast_update_request:, stream_id:, simulcast_id:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::UpdateSpecificSimulcastOfStreamResponse.new(
            ...
            content_type: content_type,
            raw_response: http_response,
            simulcast_update_response: T.unsafe(obj)
          )
