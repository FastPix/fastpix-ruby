...
module FastpixApiSDK
  ...
  class InputVideo
    ...
    sig { params(request: Models::Components::CreateMediaRequest, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::CreateMediaResponse) }
    def create_media(request:, retries: nil, timeout_ms: nil)
    ...
    sig { params(cors_origin: T.nilable(String), push_media_settings: T.nilable(Models::Operations::PushMediaSettings), metadata: T.nilable(T::Hash[Symbol, String]), access_policy: T.nilable(Models::Components::BasicAccessPolicy), request: T.nilable(Models::Operations::DirectUploadVideoMediaRequest), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::DirectUploadVideoMediaResponse) }
    def direct_upload_video_media(cors_origin: nil, push_media_settings: nil, metadata: nil, access_policy: nil, request: nil, retries: nil, timeout_ms: nil)
      ...
      # 
      # Create request object if direct parameters are provided
      if request.nil? && !cors_origin.nil?
        # Create push_media_settings if metadata or access_policy are provided
        if push_media_settings.nil? && (metadata || access_policy)
          push_media_settings = Models::Operations::PushMediaSettings.new(
            access_policy: access_policy || Models::Components::BasicAccessPolicy::PUBLIC,
            metadata: metadata
          )
        end
        
        request = Models::Operations::DirectUploadVideoMediaRequest.new(
