...
module FastpixApiSDK
  ...
  class Metrics
    ...
    sig { params(request: Models::Operations::ListBreakdownValuesRequest, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListBreakdownValuesResponse) }
    def list_breakdown_values(request:, retries: nil, timeout_ms: nil)
    ...
    sig { params(metric_id: Models::Operations::ListOverallValuesMetricId, timespan: Models::Operations::ListOverallValuesTimespan, measurement: T.nilable(::String), filterby: T.nilable(::String), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListOverallValuesResponse) }
    def list_overall_values(metric_id:, timespan:, measurement: nil, filterby: nil, retries: nil, timeout_ms: nil)
    ...
    sig { params(request: Models::Operations::GetTimeseriesDataRequest, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetTimeseriesDataResponse) }
    def get_timeseries_data(request:, retries: nil, timeout_ms: nil)
    ...
    sig { params(timespan: Models::Operations::ListComparisonValuesTimespan, filterby: T.nilable(::String), dimension: T.nilable(Models::Operations::ListComparisonValuesDimension), value: T.nilable(::String), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListComparisonValuesResponse) }
    def list_comparison_values(timespan:, filterby: nil, dimension: nil, value: nil, retries: nil, timeout_ms: nil)
