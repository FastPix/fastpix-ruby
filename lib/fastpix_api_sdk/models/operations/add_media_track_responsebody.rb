  ...
  module Models
    module Operations
      ...
      class AddMediaTrackResponseBody
        ...
        field :data, Crystalline::Nilable.new(Models::Components::AddTrackResponse), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('data') } }

        sig { params(success: T.nilable(T::Boolean), data: T.nilable(Models::Components::AddTrackResponse)).void }
