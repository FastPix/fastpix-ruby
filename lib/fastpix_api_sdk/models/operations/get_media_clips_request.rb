  ...
  module Models
    module Operations
      ...
      class GetMediaClipsRequest
        ...
        field :source_media_id, ::String, { 'path_param': { 'field_name': 'sourceMediaId', 'style': 'simple', 'explode': false } }
        ...
        sig { params(source_media_id: ::String, offset: T.nilable(::Integer), limit: T.nilable(::Integer), order_by: T.nilable(Models::Components::SortOrder)).void }
        def initialize(source_media_id:, offset: 1, limit: 10, order_by: Models::Components::SortOrder::DESC)
