  ...
  module Models
    module Operations
      ...
      class ListBreakdownValuesRequest
        ...
        # 
        field :timespan, Models::Operations::ListBreakdownValuesTimespan, { 'query_param': { 'field_name': 'timespan[]', 'style': 'form', 'explode': true } }
        ...
        sig { params(metric_id: Models::Operations::ListBreakdownValuesMetricId, timespan: Models::Operations::ListBreakdownValuesTimespan, filterby: T.nilable(::String), group_by: T.nilable(::String), limit: T.nilable(::Integer), offset: T.nilable(::Integer), order_by: T.nilable(::String), sort_order: T.nilable(Models::Operations::ListBreakdownValuesSortOrder), measurement: T.nilable(::String)).void }
        def initialize(metric_id:, timespan:, filterby: nil, group_by: nil, limit: 10, offset: 1, order_by: 'views', sort_order: Models::Operations::ListBreakdownValuesSortOrder::ASC, measurement: 'avg')
          @metric_id = metric_id
          @timespan = timespan
          @filterby = filterby
          @group_by = group_by
