  ...
  module Models
    module Operations
      ...
      class ListFilterValuesForDimensionResponseBody
        ...
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::BrowserNameDimensiondetails)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), data: T.nilable(T::Array[Models::Components::BrowserNameDimensiondetails]), timespan: T.nilable(T::Array[::Integer])).void }
