  ...
  module Models
    module Operations
      ...
      class ListVideoViewsRequest
        ...
        # 
        field :timespan, Models::Operations::ListVideoViewsTimespan, { 'query_param': { 'field_name': 'timespan[]', 'style': 'form', 'explode': true } }
        ...
        # 
        field :error_code, Crystalline::Nilable.new(Crystalline::Union.new(::String, ::Integer)), { 'query_param': { 'field_name': 'errorCode', 'style': 'form', 'explode': true } }
        ...
        sig { params(timespan: Models::Operations::ListVideoViewsTimespan, filterby: T.nilable(::String), viewer_id: T.nilable(::String), limit: T.nilable(::Integer), offset: T.nilable(::Integer), error_code: T.nilable(T.any(::String, ::Integer)), order_by: T.nilable(::String), sort_order: T.nilable(::String)).void }
        def initialize(timespan:, filterby: nil, viewer_id: nil, limit: 10, offset: 1, error_code: nil, order_by: 'view_end', sort_order: 'asc')
          @timespan = timespan
          @filterby = filterby
          @viewer_id = viewer_id
          @limit = limit
