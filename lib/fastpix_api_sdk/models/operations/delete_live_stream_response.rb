  ...
  module Models
    module Operations
      ...
      class DeleteLiveStreamResponse
        ...
        # Alias for live_stream_delete_response to match test expectations
        sig { returns(T.nilable(Models::Components::LiveStreamDeleteResponse)) }
        def object
          @live_stream_delete_response
        end
