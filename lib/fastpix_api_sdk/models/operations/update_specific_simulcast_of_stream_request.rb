  ...
  module Models
    module Operations
      ...
      class UpdateSpecificSimulcastOfStreamRequest
        ...
        field :simulcast_update_request, Models::Components::SimulcastUpdateRequest, { 'request': { 'media_type': 'application/json' } }

        sig { params(stream_id: ::String, simulcast_id: ::String, simulcast_update_request: Models::Components::SimulcastUpdateRequest).void }
        def initialize(stream_id:, simulcast_id:, simulcast_update_request:)
          @stream_id = stream_id
