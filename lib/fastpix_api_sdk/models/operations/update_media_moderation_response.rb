  ...
  module Models
    module Operations
      ...
      class UpdateMediaModerationResponse
        ...
        sig { params(content_type: ::String, status_code: ::Integer, raw_response: ::Faraday::Response, object: T.nilable(Models::Operations::UpdateMediaModerationResponseBody)).void }
