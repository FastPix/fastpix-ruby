  ...
  module Models
    module Operations
      ...
      class DirectUploadVideoMediaRequest
        ...
        field :push_media_settings, Crystalline::Nilable.new(Models::Operations::PushMediaSettings), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('pushMediaSettings') } }
