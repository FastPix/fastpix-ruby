  ...
  module Models
    module Operations
      ...
      class UpdateMediaTrackResponseBody
        ...
        field :data, Crystalline::Nilable.new(Models::Components::UpdateTrackResponse), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('data') } }

        sig { params(success: T.nilable(T::Boolean), data: T.nilable(Models::Components::UpdateTrackResponse)).void }
