  ...
  module Models
    module Operations
      ...
      class ListBreakdownValuesResponseBody
        ...
        # Retrieves breakdown values for a specified metric and timespan
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::MetricsBreakdownDetails)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), meta_data: T.nilable(Models::Components::MetricsTimeseriesMetaDataDetails), data: T.nilable(T::Array[Models::Components::MetricsBreakdownDetails]), timespan: T.nilable(T::Array[::Integer])).void }
