  ...
  module Models
    module Operations
      ...
      class RetrieveMediaInputInfoResponseBody
        ...
        field :data, T.nilable(::Object), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('data') } }

        sig { params(success: T.nilable(T::Boolean), data: T.nilable(::Object)).void }
