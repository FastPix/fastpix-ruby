  ...
  module Models
    module Operations
      ...
      class UpdateMediaNamedEntitiesResponse
        ...
        sig { params(content_type: ::String, status_code: ::Integer, raw_response: ::Faraday::Response, object: T.nilable(Models::Operations::UpdateMediaNamedEntitiesResponseBody)).void }
