  ...
  module Models
    module Operations
      ...
      class ListErrorsRequest
        ...
        # 
        field :timespan, Models::Operations::ListErrorsTimespan, { 'query_param': { 'field_name': 'timespan[]', 'style': 'form', 'explode': true } }
        ...
        sig { params(timespan: Models::Operations::ListErrorsTimespan, filterby: T.nilable(::String), limit: T.nilable(::Integer)).void }
        def initialize(timespan:, filterby: nil, limit: 1)
          @timespan = timespan
          @filterby = filterby
          @limit = limit
        end
