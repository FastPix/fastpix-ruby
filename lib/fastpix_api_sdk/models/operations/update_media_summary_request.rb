  ...
  module Models
    module Operations
      ...
      class UpdateMediaSummaryRequest
        ...
        field :request_body, Models::Operations::UpdateMediaSummaryRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, request_body: Models::Operations::UpdateMediaSummaryRequestBody).void }
