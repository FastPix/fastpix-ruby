  ...
  module Models
    module Operations
      ...
      class CreateMediaPlaybackIdRequestBody
        ...
        field :access_policy, Models::Components::AccessPolicy, { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('accessPolicy'), required: true, 'decoder': Utils.enum_from_string(Models::Components::AccessPolicy, false) } }

        field :access_restrictions, Crystalline::Nilable.new(Models::Operations::CreateMediaPlaybackIdAccessRestrictions), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('accessRestrictions') } }
        # DRM configuration ID (required if accessPolicy is 'drm')
        field :drm_configuration_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('drmConfigurationId') } }
        # The maximum resolution for the playback ID.
        field :resolution, Crystalline::Nilable.new(Models::Operations::Resolution), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('resolution'), 'decoder': Utils.enum_from_string(Models::Operations::Resolution, true) } }
