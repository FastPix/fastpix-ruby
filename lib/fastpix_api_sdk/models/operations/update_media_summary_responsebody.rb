  ...
  module Models
    module Operations
      ...
      class UpdateMediaSummaryResponseBody
        ...
        field :data, Crystalline::Nilable.new(Models::Components::SummaryResponse), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('data') } }

        sig { params(success: T.nilable(T::Boolean), data: T.nilable(Models::Components::SummaryResponse)).void }
