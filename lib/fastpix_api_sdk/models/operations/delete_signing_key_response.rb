  ...
  module Models
    module Operations
      ...
      class DeleteSigningKeyResponse
        ...
        sig { params(content_type: ::String, status_code: ::Integer, raw_response: ::Faraday::Response, delete_signing_key_response: T.nilable(Models::Components::DeleteSigningKeyResponse)).void }
        def initialize(content_type:, status_code:, raw_response:, delete_signing_key_response: nil)
