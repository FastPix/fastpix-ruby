  ...
  module Models
    module Operations
      ...
      class CreateSimulcastOfStreamRequest
        ...
        field :simulcast_request, Models::Components::SimulcastRequest, { 'request': { 'media_type': 'application/json' } }

        sig { params(stream_id: ::String, simulcast_request: Models::Components::SimulcastRequest).void }
        def initialize(stream_id:, simulcast_request:)
          @stream_id = stream_id
