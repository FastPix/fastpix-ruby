  ...
  module Models
    module Operations
      ...
      class UpdateMediaModerationRequest
        ...
        field :request_body, Models::Operations::UpdateMediaModerationRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, request_body: Models::Operations::UpdateMediaModerationRequestBody).void }
