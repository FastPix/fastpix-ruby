  ...
  module Models
    module Operations
      ...
      class UpdateMediaNamedEntitiesRequest
        ...
        field :request_body, Models::Operations::UpdateMediaNamedEntitiesRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, request_body: Models::Operations::UpdateMediaNamedEntitiesRequestBody).void }
        def initialize(media_id:, request_body:)
          @media_id = media_id
