...
module FastpixApiSDK
  module Models
    module Errors
      ...
      class ForbiddenResponseError < StandardError
        extend T::Sig
        ...
        field :error, Crystalline::Nilable.new(Models::Components::ForbiddenResponseError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::ForbiddenResponseError), raw_response: T.nilable(::Faraday::Response)).void }
