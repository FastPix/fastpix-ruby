  ...
  module Models
    module Errors
      ...
      class ForbiddenError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::ForbiddenError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::ForbiddenError), raw_response: T.nilable(::Faraday::Response)).void }
