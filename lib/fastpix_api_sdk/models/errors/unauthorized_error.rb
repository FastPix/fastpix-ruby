  ...
  module Models
    module Errors
      ...
      class UnauthorizedError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::UnauthorizedError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::UnauthorizedError), raw_response: T.nilable(::Faraday::Response)).void }
