  ...
  module Models
    module Errors
      ...
      class UnAuthorizedResponseError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::UnAuthorizedResponseError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::UnAuthorizedResponseError), raw_response: T.nilable(::Faraday::Response)).void }
