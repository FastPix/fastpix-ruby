  ...
  module Models
    module Errors
      ...
      class ViewNotFoundError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::ViewNotFoundError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::ViewNotFoundError), raw_response: T.nilable(::Faraday::Response)).void }
