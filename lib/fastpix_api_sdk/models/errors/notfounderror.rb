  ...
  module Models
    module Errors
      ...
      class NotFoundError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::NotFoundErrorError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::NotFoundErrorError), raw_response: T.nilable(::Faraday::Response)).void }
