  ...
  module Models
    module Errors
      ...
      class InvalidPermissionError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::InvalidPermissionError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::InvalidPermissionError), raw_response: T.nilable(::Faraday::Response)).void }
