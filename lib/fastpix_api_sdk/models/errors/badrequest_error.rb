  ...
  module Models
    module Errors
      ...
      class BadRequestError < StandardError
        ...
        field :error, Crystalline::Nilable.new(Models::Components::BadRequestError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::BadRequestError), raw_response: T.nilable(::Faraday::Response)).void }
