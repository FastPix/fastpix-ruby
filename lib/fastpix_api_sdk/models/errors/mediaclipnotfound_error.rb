...
module FastpixApiSDK
  module Models
    module Errors
      ...
      class MediaClipNotFoundError < StandardError
        extend T::Sig
        ...
        field :error, Crystalline::Nilable.new(Models::Components::MediaClipNotFoundError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::MediaClipNotFoundError), raw_response: T.nilable(::Faraday::Response)).void }
