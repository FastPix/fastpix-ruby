...
module FastpixApiSDK
  module Models
    module Errors
      ...
      class DuplicateMp4SupportError < StandardError
        extend T::Sig
        ...
        field :error, Crystalline::Nilable.new(Models::Components::DuplicateMp4SupportError), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('error') } }
        ...
        sig { params(success: T.nilable(T::Boolean), error: T.nilable(Models::Components::DuplicateMp4SupportError), raw_response: T.nilable(::Faraday::Response)).void }
