  ...
  module Models
    module Components
      ...
      class GenerateTrackResponse
        ...
        field :type, Crystalline::Nilable.new(Models::Components::GenerateTrackResponseType), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::GenerateTrackResponseType, true) } }
        # The BCP 47 language code representing the language of the generated track.
        # 
        field :language_code, Crystalline::Nilable.new(Models::Components::GenerateTrackResponseLanguageCode), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('languageCode'), 'decoder': Utils.enum_from_string(Models::Components::GenerateTrackResponseLanguageCode, true) } }
