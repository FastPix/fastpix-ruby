  ...
  module Models
    module Components
      ...
      class WatermarkInput
        ...
        field :type, Crystalline::Nilable.new(Models::Components::WatermarkInputType), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::WatermarkInputType, true) } }
        # URL of the watermark image.
        field :url, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('url') } }

        field :placement, Crystalline::Nilable.new(Models::Components::Placement), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('placement') } }
        # Width of the watermark in percentage or pixels.
        field :width, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('width') } }
        # Height of the watermark in percentage or pixels.
        field :height, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('height') } }
        # Opacity of the watermark in percentage.
        field :opacity, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('opacity') } }
