  ...
  module Models
    module Components
      ...
      class GetCreateLiveStreamResponseDTO
        ...
        field :media_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('mediaIds') } }
        ...
        sig { params(stream_id: T.nilable(::String), stream_key: T.nilable(::String), srt_secret: T.nilable(::String), trial: T.nilable(T::Boolean), status: T.nilable(::String), max_resolution: T.nilable(::String), max_duration: T.nilable(::Integer), created_at: T.nilable(::DateTime), enable_recording: T.nilable(T::Boolean), media_policy: T.nilable(::String), metadata: T.nilable(T::Hash[Symbol, ::String]), enable_dvr_mode: T.nilable(T::Boolean), playback_ids: T.nilable(T::Array[Models::Components::PlaybackIdResponse]), media_ids: T.nilable(T::Array[::String]), srt_playback_response: T.nilable(Models::Components::SrtPlaybackResponse), reconnect_window: T.nilable(::Integer)).void }
        def initialize(stream_id: nil, stream_key: nil, srt_secret: nil, trial: nil, status: nil, max_resolution: nil, max_duration: nil, created_at: nil, enable_recording: nil, media_policy: nil, metadata: nil, enable_dvr_mode: nil, playback_ids: nil, media_ids: nil, srt_playback_response: nil, reconnect_window: 60)
          @stream_id = stream_id
