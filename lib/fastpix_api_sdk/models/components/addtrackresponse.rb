  ...
  module Models
    module Components
      ...
      class AddTrackResponse
        ...
        field :type, Crystalline::Nilable.new(Models::Components::AddTrackResponseType), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::AddTrackResponseType, true) } }
