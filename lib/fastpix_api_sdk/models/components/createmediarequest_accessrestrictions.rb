  ...
  module Models
    module Components
      ...
      class CreateMediaRequestAccessRestrictions
        ...
        field :domains, Crystalline::Nilable.new(Models::Components::CreateMediaRequestDomains), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('domains') } }

        field :user_agents, Crystalline::Nilable.new(Models::Components::CreateMediaRequestUserAgents), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('userAgents') } }
