  ...
  module Models
    module Components
      ...
      class ImposeTrack
        ...
        field :start_time, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('startTime') } }
        # End time (in seconds) of the imposed audio in the video.
        field :end_time, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('endTime') } }
        # Level of fade-in effect (in seconds) at the start of the imposed audio.
        field :fade_in_level, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('fadeInLevel') } }
        # Level of fade-out effect (in seconds) at the end of the imposed audio.
        field :fade_out_level, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('fadeOutLevel') } }
