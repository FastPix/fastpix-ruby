  ...
  module Models
    module Components
      ...
      class SrtPlaybackResponse
        ...
        field :srt_playback_stream_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('srtPlaybackStreamId') } }
        ...
        field :srt_playback_secret, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('srtPlaybackSecret') } }
