  ...
  module Models
    module Components
      ...
      class AddTrackRequest
        ...
        field :type, Crystalline::Nilable.new(Models::Components::AddTrackRequestType), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::AddTrackRequestType, true) } }
        ...
        def initialize(url: nil, type: nil, language_code: nil, language_name: nil)
          @url = url
          @type = type
