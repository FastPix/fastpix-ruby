  ...
  module Models
    module Components
      ...
      class GetPublicPemUsingSigningKeyIdResponseDTOData
        ...
        field :signing_key_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('signingKeyId') } }
        # A public key is a byte encoded key used to create a signed JSON Web Token (JWT) for authentication.
        field :public_key, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('publicKey') } }
