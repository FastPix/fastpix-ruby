  ...
  module Models
    module Components
      ...
      class DirectUpload
        ...
        field :push_media_settings, Crystalline::Nilable.new(Models::Components::DirectUploadResponse), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('pushMediaSettings') } }
        ...
        # 
        field :timeout, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('timeout') } }
