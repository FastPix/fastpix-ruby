  ...
  module Models
    module Components
      ...
      class UpdateTrackResponse
        ...
        field :type, Crystalline::Nilable.new(Models::Components::UpdateTrackResponseType), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::UpdateTrackResponseType, true) } }
