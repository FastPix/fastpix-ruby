  ...
  module Models
    module Components
      ...
      class Media
        ...
        field :mp4_support, Crystalline::Nilable.new(Models::Components::MediaMp4Support), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('mp4Support'), 'decoder': Utils.enum_from_string(Models::Components::MediaMp4Support, true) } }
        ...
        field :tracks, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::Track)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('tracks') } }
        ...
        field :max_resolution, Crystalline::Nilable.new(Models::Components::MediaMaxResolution), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('maxResolution'), 'decoder': Utils.enum_from_string(Models::Components::MediaMaxResolution, true) } }
        # The actual resolution of the uploaded media. This represents the native quality of the source media.
        field :source_resolution, Crystalline::Nilable.new(Models::Components::MediaSourceResolution), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('sourceResolution'), 'decoder': Utils.enum_from_string(Models::Components::MediaSourceResolution, true) } }

        sig { params(thumbnail: T.nilable(::String), id: T.nilable(::String), workspace_id: T.nilable(::String), metadata: T.nilable(T::Hash[Symbol, ::String]), status: T.nilable(::String), mp4_support: T.nilable(Models::Components::MediaMp4Support), source_access: T.nilable(T::Boolean), playback_ids: T.nilable(T::Array[Models::Components::PlaybackId]), tracks: T.nilable(T::Array[Models::Components::Track]), duration: T.nilable(::String), frame_rate: T.nilable(::String), aspect_ratio: T.nilable(::String), created_at: T.nilable(::DateTime), updated_at: T.nilable(::DateTime), max_resolution: T.nilable(Models::Components::MediaMaxResolution), source_resolution: T.nilable(Models::Components::MediaSourceResolution)).void }
        def initialize(thumbnail: nil, id: nil, workspace_id: nil, metadata: nil, status: nil, mp4_support: nil, source_access: nil, playback_ids: nil, tracks: nil, duration: nil, frame_rate: nil, aspect_ratio: nil, created_at: nil, updated_at: nil, max_resolution: Models::Components::MediaMaxResolution::ONE_THOUSAND_AND_EIGHTYP, source_resolution: Models::Components::MediaSourceResolution::ONE_THOUSAND_AND_EIGHTYP)
          @thumbnail = thumbnail
          @id = id
