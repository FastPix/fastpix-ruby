  ...
  module Models
    module Components
      ...
      class AudioInput
        ...
        field :type, Crystalline::Nilable.new(Models::Components::AudioInputType), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::AudioInputType, true) } }
        # URL of the audio track to replace the existing audio in the video.
        field :swap_track_url, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('swapTrackUrl') } }
        # List of additional audio tracks to overlay on the video.
        field :impose_tracks, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::ImposeTrack)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('imposeTracks') } }
