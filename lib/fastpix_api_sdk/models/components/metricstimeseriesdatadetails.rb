  ...
  module Models
    module Components
      ...
      class MetricsTimeseriesDataDetails
        ...
        field :metric_value, Crystalline::Nilable.new(Crystalline::Union.new(::Integer, ::Float)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('metricValue') } }
        ...
        sig { params(interval_time: T.nilable(::DateTime), metric_value: T.nilable(T.any(::Integer, ::Float)), number_of_views: T.nilable(::Integer)).void }
