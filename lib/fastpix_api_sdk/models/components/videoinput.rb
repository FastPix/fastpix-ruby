  ...
  module Models
    module Components
      ...
      class VideoInput
        ...
        # 
        field :intro_url, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('introUrl') } }
        # The url of the outro video which is to be added at the end of the video.
        # 
        field :outro_url, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('outroUrl') } }
        # The list of the startTime-endTime of the segments to be removed from the actual video.
        # 
        field :expunge_segments, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('expungeSegments') } }
        ...
        field :segments, Crystalline::Nilable.new(Crystalline::Array.new(Crystalline::Union.new(Models::Components::Segment1, Models::Components::Segment2))), { 'format_json': { 'letter_case': ::FastpixApiSDK::Utils.field_name('segments') } }
