...
module FastpixApiSDK
  ...
  class Views
    ...
    sig { params(request: Models::Operations::ListVideoViewsRequest, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListVideoViewsResponse) }
    def list_video_views(request:, retries: nil, timeout_ms: nil)
    ...
    sig { params(view_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetVideoViewDetailsResponse) }
    def get_video_view_details(view_id:, retries: nil, timeout_ms: nil)
    ...
    sig { params(timespan: Models::Operations::ListByTopContentTimespan, filterby: T.nilable(::String), limit: T.nilable(::Integer), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListByTopContentResponse) }
    def list_by_top_content(timespan:, filterby: nil, limit: nil, retries: nil, timeout_ms: nil)
    ...
    sig { params(retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetDataViewlistCurrentViewsGetTimeseriesViewsResponse) }
    def get_data_viewlist_current_views_get_timeseries_views(retries: nil, timeout_ms: nil)
      # get_data_viewlist_current_views_get_timeseries_views - Get concurrent viewers timeseries
      ...
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/data/viewlist/current-views/getTimeseriesViews"
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Operations::GetDataViewlistCurrentViewsGetTimeseriesViewsResponseBody)
          response = Models::Operations::GetDataViewlistCurrentViewsGetTimeseriesViewsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            object: T.unsafe(obj)
    ...
    sig { params(dimension: T.nilable(Models::Operations::GetDataViewlistCurrentViewsFilterDimension), limit: T.nilable(::Integer), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetDataViewlistCurrentViewsFilterResponse) }
    def get_data_viewlist_current_views_filter(dimension: nil, limit: nil, retries: nil, timeout_ms: nil)
      # get_data_viewlist_current_views_filter - Get concurrent viewers breakdown by dimension
      ...
      # 
      request = Models::Operations::GetDataViewlistCurrentViewsFilterRequest.new(
        dimension: dimension,
        limit: limit
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/data/viewlist/current-views/filter"
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      query_params = Utils.get_query_params(Models::Operations::GetDataViewlistCurrentViewsFilterRequest, request, nil)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      retries ||= @sdk_configuration.retry_config
      retries ||= Utils::RetryConfig.new(
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Operations::GetDataViewlistCurrentViewsFilterResponseBody)
          response = Models::Operations::GetDataViewlistCurrentViewsFilterResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            object: T.unsafe(obj)
