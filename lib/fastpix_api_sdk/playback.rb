...
module FastpixApiSDK
  ...
  class Playback
    ...
    sig { params(media_id: ::String, request_body: T.nilable(Models::Operations::CreateMediaPlaybackIdRequestBody), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::CreateMediaPlaybackIdResponse) }
    def create_media_playback_id(media_id:, request_body: nil, retries: nil, timeout_ms: nil)
    ...
    sig { params(media_id: ::String, playback_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::DeleteMediaPlaybackIdResponse) }
    def delete_media_playback_id(media_id:, playback_id:, retries: nil, timeout_ms: nil)
    ...
    sig { params(media_id: ::String, playback_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetPlaybackIdResponse) }
    def get_playback_id(media_id:, playback_id:, retries: nil, timeout_ms: nil)
