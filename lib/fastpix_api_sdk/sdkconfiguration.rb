...
module FastpixApiSDK
  ...
  class SDKConfiguration
    ...
    field :hooks, ::FastpixApiSDK::SDKHooks::Hooks
    field :retry_config, T.nilable(::FastpixApiSDK::Utils::RetryConfig)
    ...
    field :fastpixapi_doc_version, String
    ...
    def initialize(client, hooks, retry_config, timeout_ms, security, security_source, server_url, server_idx)
      ...
      @language = 'ruby'
      @fastpixapi_doc_version = '1.0.0'
      @sdk_version = '0.0.1'
      @gen_version = '2.628.0'
      @user_agent = 'speakeasy-sdk/ruby 0.0.1 2.628.0 1.0.0 fastpixapi'
    end
