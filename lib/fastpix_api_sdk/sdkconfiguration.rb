...
module FastpixApiSDK
  ...
  class SDKConfiguration
    ...
    sig { returns(::FastpixApiSDK::SDKHooks::Hooks) }
    attr_accessor :hooks

    sig { returns(T.nilable(::FastpixApiSDK::Utils::RetryConfig)) }
    ...
    sig do
      params(
        ...
        hooks: ::FastpixApiSDK::SDKHooks::Hooks,
    ...
    def initialize(client, hooks, retry_config, timeout_ms, security, security_source, server_url, server_idx)
      ...
      @sdk_version = '1.0.0'
      @gen_version = '2.723.4'
      @user_agent = 'fastpix-sdk/ruby 1.0.0 2.723.4 1.0.0 fastpixapi'
    end
