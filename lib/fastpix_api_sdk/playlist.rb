...
module FastpixApiSDK
  ...
  class Playlist
    ...
    sig { params(request: Models::Components::CreatePlaylistRequest, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::CreateAPlaylistResponse) }
    def create_a_playlist(request:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['201'])
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::DuplicateReferenceIdErrorResponse)
          obj.raw_response = http_response
          raise obj
        else
          raise ::FastpixApiSDK::Models::Errors::APIError.new(status_code: http_response.status, body: http_response.env.response_body, raw_response: http_response), 'Unknown content type received'
    ...
    sig { params(limit: T.nilable(::Integer), offset: T.nilable(::Integer), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetAllPlaylistsResponse) }
    def get_all_playlists(limit: nil, offset: nil, retries: nil, timeout_ms: nil)
    ...
    sig { params(playlist_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetPlaylistByIdResponse) }
    def get_playlist_by_id(playlist_id:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::InvalidPlaylistIdResponseError)
          obj.raw_response = http_response
          raise obj
        else
          raise ::FastpixApiSDK::Models::Errors::APIError.new(status_code: http_response.status, body: http_response.env.response_body, raw_response: http_response), 'Unknown content type received'
    ...
    sig { params(update_playlist_request: Models::Components::UpdatePlaylistRequest, playlist_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::UpdateAPlaylistResponse) }
    def update_a_playlist(update_playlist_request:, playlist_id:, retries: nil, timeout_ms: nil)
      ...
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :update_playlist_request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
    ...
    sig { params(playlist_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::DeleteAPlaylistResponse) }
    def delete_a_playlist(playlist_id:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::SuccessResponse)
    ...
    sig { params(media_ids_request: Models::Components::MediaIdsRequest, playlist_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::AddMediaToPlaylistResponse) }
    def add_media_to_playlist(media_ids_request:, playlist_id:, retries: nil, timeout_ms: nil)
      ...
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :media_ids_request, :json)
      headers['content-type'] = req_content_type
      raise StandardError, 'request body is required' if data.nil? && form.nil?
    ...
    sig { params(media_ids_request: Models::Components::MediaIdsRequest, playlist_id: ::String, retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ChangeMediaOrderInPlaylistResponse) }
    def change_media_order_in_playlist(media_ids_request:, playlist_id:, retries: nil, timeout_ms: nil)
    ...
    sig { params(playlist_id: ::String, media_ids_request: T.nilable(Models::Components::MediaIdsRequest), retries: T.nilable(Utils::RetryConfig), timeout_ms: T.nilable(Integer)).returns(Models::Operations::DeleteMediaFromPlaylistResponse) }
    def delete_media_from_playlist(playlist_id:, media_ids_request: nil, retries: nil, timeout_ms: nil)
