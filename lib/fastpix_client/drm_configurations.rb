...
module FastpixClient
  ...
  class DRMConfigurations
    ...
    sig { params(offset: T.nilable(::Integer), limit: T.nilable(::Integer), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetDrmConfigurationResponse) }
    def get_drm_configuration(offset: nil, limit: nil, timeout_ms: nil)
      # get_drm_configuration - Get list of DRM configuration IDs
      # 
      ...
      url = "#{base_url}/on-demand/drm-configurations"
      headers = {}
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Operations::GetDrmConfigurationResponseBody)
          response = Models::Operations::GetDrmConfigurationResponse.new(
    ...
    sig { params(drm_configuration_id: ::String, timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetDrmConfigurationByIdResponse) }
    def get_drm_configuration_by_id(drm_configuration_id:, timeout_ms: nil)
      # get_drm_configuration_by_id - Get DRM configuration by ID
      # 
      ...
      url = Utils.generate_url(
        Models::Operations::GetDrmConfigurationByIdRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Operations::GetDrmConfigurationByIdResponseBody)
          response = Models::Operations::GetDrmConfigurationByIdResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            object: T.unsafe(obj)
