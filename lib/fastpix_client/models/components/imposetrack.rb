  ...
  module Models
    module Components
      ...
      class ImposeTrack
        ...
        field :fade_in_level, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('fadeInLevel') } }
        # Level of fade-out effect (in seconds) at the end of the imposed audio.
        field :fade_out_level, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('fadeOutLevel') } }
