  ...
  module Models
    module Components
      ...
      class UpdateTrackResponse
        ...
        field :type, Crystalline::Nilable.new(Models::Components::UpdateTrackResponseType), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::UpdateTrackResponseType, true) } }
        ...
        sig { params(id: T.nilable(::String), type: T.nilable(T.any(Models::Components::UpdateTrackResponseType, String)), url: T.nilable(::String), language_code: T.nilable(::String), language_name: T.nilable(::String), title: T.nilable(::String)).void }
