  ...
  module Models
    module Components
      ...
      class ModerationResponse
        ...
        field :is_moderation_enabled, Crystalline::Nilable.new(Crystalline::Boolean.new), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('isModerationEnabled') } }
