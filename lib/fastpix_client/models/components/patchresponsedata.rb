  ...
  module Models
    module Components
      ...
      class PatchResponseData
        ...
        sig { params(stream_id: T.nilable(::String), stream_key: T.nilable(::String), srt_secret: T.nilable(::String), trial: T.nilable(T::Boolean), status: T.nilable(::String), max_resolution: T.nilable(::String), max_duration: T.nilable(::Integer), created_at: T.nilable(::DateTime), reconnect_window: T.nilable(::Integer), enable_recording: T.nilable(T::Boolean), enable_dvr_mode: T.nilable(T::Boolean), media_policy: T.nilable(::String), metadata: T.nilable(T::Hash[Symbol, ::String]), low_latency: T.nilable(T::Boolean), closed_captions: T.nilable(T::Boolean), playback_ids: T.nilable(T::Array[Models::Components::PlaybackIdResponse]), srt_playback_response: T.nilable(Models::Components::SrtPlaybackResponse)).void }
