  ...
  module Models
    module Components
      ...
      class UnusedUploadsPlaybackIdUserAgents
        ...
        # Policy action type
        field :default_policy, Crystalline::Nilable.new(Models::Components::PolicyAction), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('defaultPolicy'), 'decoder': Utils.enum_from_string(Models::Components::PolicyAction, true) } }
