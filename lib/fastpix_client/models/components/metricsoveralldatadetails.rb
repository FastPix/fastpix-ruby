  ...
  module Models
    module Components
      ...
      class MetricsOverallDataDetails
        ...
        field :unique_views, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('uniqueViews') } }
        # The total number of views recorded.
        field :total_views, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('totalViews') } }
        # Total time spent playing the video, represented in milliseconds.
        field :total_play_time, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('totalPlayTime') } }
        ...
        field :global_value, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('globalValue') } }

        sig { params(value: T.nilable(::Float), total_watch_time: T.nilable(::Integer), unique_views: T.nilable(::Integer), total_views: T.nilable(::Integer), total_play_time: T.nilable(::Integer), global_value: T.nilable(::Float)).void }
