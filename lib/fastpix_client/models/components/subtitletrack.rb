  ...
  module Models
    module Components
      ...
      class SubtitleTrack
        ...
        sig { params(id: T.nilable(::String), type: T.nilable(T.any(Models::Components::SubtitleTrackType, String)), status: T.nilable(::String), title: T.nilable(::String), language_name: T.nilable(::String), language_code: T.nilable(::String)).void }
