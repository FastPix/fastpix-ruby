  ...
  module Models
    module Components
      ...
      class Subtitles
        ...
        # 
        field :language_code, Crystalline::Nilable.new(Models::Components::CreateMediaRequestLanguageCode), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('languageCode'), 'decoder': Utils.enum_from_string(Models::Components::CreateMediaRequestLanguageCode, true) } }
