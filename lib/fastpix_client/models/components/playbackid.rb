  ...
  module Models
    module Components
      ...
      class PlaybackId
        ...
        sig { params(access_policy: T.nilable(Models::Components::AccessPolicy), access_restrictions: T.nilable(Models::Components::PlaybackIdAccessRestrictions), id: T.nilable(::String)).void }
