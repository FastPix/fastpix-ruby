  ...
  module Models
    module Components
      ...
      class PlaybackId
        ...
        sig { params(access_policy: T.nilable(T.any(Models::Components::AccessPolicy, String)), access_restrictions: T.nilable(Models::Components::PlaybackIdAccessRestrictions), id: T.nilable(::String)).void }
        def initialize(access_policy: nil, access_restrictions: nil, id: nil)
