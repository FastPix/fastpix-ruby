  ...
  module Models
    module Components
      ...
      class CreateMediaResponse
        ...
        sig { params(id: T.nilable(::String), status: T.nilable(T.any(Models::Components::CreateMediaResponseStatus, String)), created_at: T.nilable(::DateTime), updated_at: T.nilable(::DateTime), playback_ids: T.nilable(T::Array[Models::Components::PlaybackId]), metadata: T.nilable(T::Hash[Symbol, ::String]), media_quality: T.nilable(T.any(Models::Components::CreateMediaResponseMediaQuality, String)), source_access: T.nilable(T::Boolean), max_resolution: T.nilable(T.any(Models::Components::CreateMediaResponseMaxResolution, String)), inputs: T.nilable(T::Array[Models::Components::CreateMediaResponseInput]), optimize_audio: T.nilable(T::Boolean), trial: T.nilable(T::Boolean)).void }
