  ...
  module Models
    module Components
      ...
      class UnusedDirectUploadResponse
        ...
        field :playback_ids, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::UnusedUploadsPlaybackId)), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('playbackIds') } }
        ...
        field :media_quality, Crystalline::Nilable.new(Models::Components::UnusedDirectUploadResponseMediaQuality), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('mediaQuality'), 'decoder': Utils.enum_from_string(Models::Components::UnusedDirectUploadResponseMediaQuality, true) } }
