  ...
  module Models
    module Components
      ...
      class GetAllMediaResponse
        ...
        field :source_media_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('sourceMediaId') } }
        ...
        field :media_quality, Crystalline::Nilable.new(Models::Components::GetAllMediaResponseMediaQuality), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('mediaQuality'), 'decoder': Utils.enum_from_string(Models::Components::GetAllMediaResponseMediaQuality, true) } }
        ...
        field :tracks, Crystalline::Nilable.new(Crystalline::Array.new(Crystalline::Union.new(Models::Components::VideoTrackForGetAll, Models::Components::AudioTrack, Models::Components::SubtitleTrack))), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('tracks') } }
        ...
        field :max_resolution, Crystalline::Nilable.new(Models::Components::GetAllMediaResponseMaxResolution), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('maxResolution'), 'decoder': Utils.enum_from_string(Models::Components::GetAllMediaResponseMaxResolution, true) } }
        # The actual resolution of the uploaded media. This represents the native quality of the source media.
        field :source_resolution, Crystalline::Nilable.new(Models::Components::GetAllMediaResponseSourceResolution), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('sourceResolution'), 'decoder': Utils.enum_from_string(Models::Components::GetAllMediaResponseSourceResolution, true) } }
        ...
        sig { params(id: T.nilable(::String), source_media_id: T.nilable(::String), workspace_id: T.nilable(::String), stream_id: T.nilable(::String), media_quality: T.nilable(T.any(Models::Components::GetAllMediaResponseMediaQuality, String)), creator_id: T.nilable(::String), status: T.nilable(T.any(Models::Components::GetAllMediaResponseStatus, String)), mp4_support: T.nilable(T::Array[Models::Components::GetAllMediaResponseMp4Support]), playback_ids: T.nilable(T::Array[Models::Components::PlaybackId]), tracks: T.nilable(T::Array[T.any(Models::Components::VideoTrackForGetAll, Models::Components::AudioTrack, Models::Components::SubtitleTrack)]), summary: T.nilable(Models::Components::AiSummaryRecord), chapters: T.nilable(Models::Components::AiResponseRecord), named_entities: T.nilable(Models::Components::AiResponseRecord), moderation: T.nilable(Models::Components::AiResponseRecord), duration: T.nilable(::Float), frame_rate: T.nilable(::String), created_at: T.nilable(::DateTime), updated_at: T.nilable(::DateTime), thumbnail: T.nilable(::String), metadata: T.nilable(T::Hash[Symbol, ::String]), title: T.nilable(::String), max_resolution: T.nilable(T.any(Models::Components::GetAllMediaResponseMaxResolution, String)), source_resolution: T.nilable(T.any(Models::Components::GetAllMediaResponseSourceResolution, String)), source_access: T.nilable(T::Boolean), generated_subtitles: T.nilable(T::Array[Models::Components::TracksSubtitles]), is_audio_only: T.nilable(T::Boolean), subtitle_available: T.nilable(T::Boolean), optimize_audio: T.nilable(T::Boolean), aspect_ratio: T.nilable(::String)).void }
