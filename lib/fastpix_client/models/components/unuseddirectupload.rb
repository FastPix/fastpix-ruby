  ...
  module Models
    module Components
      ...
      class UnusedDirectUpload
        ...
        field :status, Crystalline::Nilable.new(Models::Components::UnusedDirectUploadStatus), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Components::UnusedDirectUploadStatus, true) } }
        ...
        field :push_media_settings, Crystalline::Nilable.new(Models::Components::UnusedDirectUploadResponse), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('pushMediaSettings') } }
