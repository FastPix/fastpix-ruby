  ...
  module Models
    module Components
      ...
      class UnusedUploadsPlaybackIdAccessRestrictions
        ...
        field :domains, Crystalline::Nilable.new(Models::Components::UnusedUploadsPlaybackIdDomains), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('domains') } }
        # Restrictions based on the user agent (which is typically a string sent by browsers or bots identifying themselves).
        field :user_agents, Crystalline::Nilable.new(Models::Components::UnusedUploadsPlaybackIdUserAgents), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('userAgents') } }

        sig { params(domains: T.nilable(Models::Components::UnusedUploadsPlaybackIdDomains), user_agents: T.nilable(Models::Components::UnusedUploadsPlaybackIdUserAgents)).void }
