  ...
  module Models
    module Components
      ...
      class PlaylistByIdResponseDataManual
        ...
        field :type, Models::Components::PlaylistByIdResponseDataManualType, { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PlaylistByIdResponseDataManualType, false) } }
        ...
        sig { params(type: Models::Components::PlaylistByIdResponseDataManualType, id: T.nilable(::String), name: T.nilable(::String), reference_id: T.nilable(::String), description: T.nilable(::String), media_list: T.nilable(T::Array[Models::Components::PlaylistByIdResponseMediaListItem]), workspace_id: T.nilable(::String), created_at: T.nilable(::DateTime), updated_at: T.nilable(::DateTime), media_count: T.nilable(::Integer)).void }
        def initialize(type:, id: nil, name: nil, reference_id: nil, description: nil, media_list: nil, workspace_id: nil, created_at: nil, updated_at: nil, media_count: nil)
          @type = type
          @id = id
          @name = name
