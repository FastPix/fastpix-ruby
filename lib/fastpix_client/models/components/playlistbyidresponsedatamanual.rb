  ...
  module Models
    module Components
      ...
      class PlaylistByIdResponseDataManual
        ...
        sig { params(type: T.any(Models::Components::PlaylistByIdResponseDataManualType, String), id: T.nilable(::String), name: T.nilable(::String), reference_id: T.nilable(::String), description: T.nilable(::String), media_list: T.nilable(T::Array[Models::Components::PlaylistByIdResponseMediaListItem]), workspace_id: T.nilable(::String), created_at: T.nilable(::DateTime), updated_at: T.nilable(::DateTime), media_count: T.nilable(::Integer)).void }
