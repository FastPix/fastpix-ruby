  ...
  module Models
    module Components
      ...
      class PlaybackIdAccessRestrictions
        ...
        field :domains, Crystalline::Nilable.new(Models::Components::PlaybackIdDomains), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('domains') } }
        # Restrictions based on the user agent (which is typically a string sent by browsers or bots identifying themselves).
        field :user_agents, Crystalline::Nilable.new(Models::Components::PlaybackIdUserAgents), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('userAgents') } }
