  ...
  module Models
    module Components
      ...
      class MediaCancelResponse
        ...
        field :timeout, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('timeout') } }
        ...
        sig { params(upload_id: T.nilable(::String), trial: T.nilable(T::Boolean), status: T.nilable(::String), url: T.nilable(::String), cors_origin: T.nilable(::String), max_resolution: T.nilable(::String), access_policy: T.nilable(::String), metadata: T.nilable(T::Hash[Symbol, ::String]), timeout: T.nilable(::Integer), title: T.nilable(::String), creator_id: T.nilable(::String)).void }
