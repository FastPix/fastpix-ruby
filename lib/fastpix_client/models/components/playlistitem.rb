  ...
  module Models
    module Components
      ...
      class PlaylistItem
        ...
        field :type, Crystalline::Nilable.new(Models::Components::PlaylistItemType), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Components::PlaylistItemType, true) } }
