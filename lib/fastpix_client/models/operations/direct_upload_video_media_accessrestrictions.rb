  ...
  module Models
    module Operations
      ...
      class DirectUploadVideoMediaAccessRestrictions
        ...
        field :domains, Crystalline::Nilable.new(Models::Operations::DirectUploadVideoMediaDomains), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('domains') } }

        field :user_agents, Crystalline::Nilable.new(Models::Operations::DirectUploadVideoMediaUserAgents), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('userAgents') } }
