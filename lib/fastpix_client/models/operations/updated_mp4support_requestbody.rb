  ...
  module Models
    module Operations
      ...
      class UpdatedMp4SupportRequestBody
        ...
        # 
        field :mp4_support, Crystalline::Nilable.new(Models::Operations::UpdatedMp4SupportMp4Support), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('mp4Support'), 'decoder': Utils.enum_from_string(Models::Operations::UpdatedMp4SupportMp4Support, true) } }
