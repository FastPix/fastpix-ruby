  ...
  module Models
    module Operations
      ...
      class ListComparisonValuesResponseBody
        ...
        # 
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::MetricsComparisonDetails)), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), data: T.nilable(T::Array[Models::Components::MetricsComparisonDetails]), timespan: T.nilable(T::Array[::Integer])).void }
