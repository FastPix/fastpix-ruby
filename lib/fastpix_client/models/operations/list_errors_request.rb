  ...
  module Models
    module Operations
      ...
      class ListErrorsRequest
        ...
        # 
        field :timespan, Crystalline::Nilable.new(Models::Operations::ListErrorsTimespan), { 'query_param': { 'field_name': 'timespan[]', 'style': 'form', 'explode': true } }
        ...
        sig { params(timespan: T.nilable(Models::Operations::ListErrorsTimespan), filterby: T.nilable(::String), limit: T.nilable(::Integer)).void }
        def initialize(timespan: nil, filterby: nil, limit: 1)
          @timespan = timespan
          @filterby = filterby
          @limit = limit
        end
