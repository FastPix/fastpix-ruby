  ...
  module Models
    module Operations
      ...
      class GetTimeseriesDataResponseBody
        ...
        field :metadata, Crystalline::Nilable.new(Models::Components::MetricsTimeseriesmetadataDetails), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('metadata') } }
        # Displays the result of the request.
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::MetricsTimeseriesDataDetails)), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), metadata: T.nilable(Models::Components::MetricsTimeseriesmetadataDetails), data: T.nilable(T::Array[Models::Components::MetricsTimeseriesDataDetails]), timespan: T.nilable(T::Array[::Integer])).void }
