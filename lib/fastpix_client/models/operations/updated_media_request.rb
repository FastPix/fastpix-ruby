  ...
  module Models
    module Operations
      ...
      class UpdatedMediaRequest
        ...
        field :body, Models::Operations::UpdatedMediaRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, body: Models::Operations::UpdatedMediaRequestBody).void }
