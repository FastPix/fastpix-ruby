  ...
  module Models
    module Operations
      ...
      class Subtitles
        ...
        # 
        field :language_code, Crystalline::Nilable.new(Models::Operations::LanguageCode), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('languageCode'), 'decoder': Utils.enum_from_string(Models::Operations::LanguageCode, true) } }
