  ...
  module Models
    module Operations
      ...
      class UpdatedMp4SupportRequest
        ...
        field :body, Models::Operations::UpdatedMp4SupportRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, body: Models::Operations::UpdatedMp4SupportRequestBody).void }
