  ...
  module Models
    module Operations
      ...
      class ListPlaybackIdsData
        ...
        sig { params(id: T.nilable(::String), access_policy: T.nilable(T.any(Models::Operations::ListPlaybackIdsAccessPolicy, String)), access_restrictions: T.nilable(Models::Operations::ListPlaybackIdsAccessRestrictions)).void }
