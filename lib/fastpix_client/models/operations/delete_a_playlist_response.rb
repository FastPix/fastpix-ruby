  ...
  module Models
    module Operations
      ...
      class DeleteAPlaylistResponse
        ...
        def initialize(content_type:, status_code:, raw_response:, playlist_delete_response: nil, default_error: nil)
          @content_type = content_type
          @status_code = status_code
          @raw_response = raw_response
          @playlist_delete_response = playlist_delete_response
        ...
        def ==(other)
          ...
          return false unless @playlist_delete_response == other.playlist_delete_response
