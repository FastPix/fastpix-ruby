  ...
  module Models
    module Operations
      ...
      class ListErrorsResponseBody
        ...
        field :data, Crystalline::Nilable.new(Models::Operations::ListErrorsData), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), data: T.nilable(Models::Operations::ListErrorsData), timespan: T.nilable(T::Array[::Integer])).void }
