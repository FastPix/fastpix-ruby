  ...
  module Models
    module Operations
      ...
      class UpdateMediaChaptersRequest
        ...
        field :body, Models::Operations::UpdateMediaChaptersRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, body: Models::Operations::UpdateMediaChaptersRequestBody).void }
