  ...
  module Models
    module Operations
      ...
      class ListLiveClipsResponseBody
        ...
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::LiveMediaClips)), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), data: T.nilable(T::Array[Models::Components::LiveMediaClips]), pagination: T.nilable(Models::Components::Pagination)).void }
