  ...
  module Models
    module Operations
      ...
      class UpdateLiveStreamRequest
        ...
        field :body, Models::Components::PatchLiveStreamRequest, { 'request': { 'media_type': 'application/json' } }

        sig { params(stream_id: ::String, body: Models::Components::PatchLiveStreamRequest).void }
