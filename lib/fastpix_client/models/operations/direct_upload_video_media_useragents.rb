  ...
  module Models
    module Operations
      ...
      class DirectUploadVideoMediaUserAgents
        ...
        # 
        field :default_policy, Crystalline::Nilable.new(Models::Operations::DirectUploadVideoMediaUserAgentsDefaultPolicy), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('defaultPolicy'), 'decoder': Utils.enum_from_string(Models::Operations::DirectUploadVideoMediaUserAgentsDefaultPolicy, true) } }
