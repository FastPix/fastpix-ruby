  ...
  module Models
    module Operations
      ...
      class ListUploadsResponseBody
        ...
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::UnusedDirectUpload)), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }
        ...
        sig { params(success: T.nilable(T::Boolean), data: T.nilable(T::Array[Models::Components::UnusedDirectUpload]), pagination: T.nilable(Models::Components::Pagination)).void }
