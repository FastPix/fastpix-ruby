  ...
  module Models
    module Operations
      ...
      class CreateMediaPlaybackIdRequest
        ...
        field :body, Models::Operations::CreateMediaPlaybackIdRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, body: Models::Operations::CreateMediaPlaybackIdRequestBody).void }
