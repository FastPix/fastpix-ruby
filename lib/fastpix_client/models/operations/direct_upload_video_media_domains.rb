  ...
  module Models
    module Operations
      ...
      class DirectUploadVideoMediaDomains
        ...
        # 
        field :default_policy, Crystalline::Nilable.new(Models::Operations::DirectUploadVideoMediaDomainsDefaultPolicy), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('defaultPolicy'), 'decoder': Utils.enum_from_string(Models::Operations::DirectUploadVideoMediaDomainsDefaultPolicy, true) } }
