  ...
  module Models
    module Operations
      ...
      class GetPlaybackIdData
        ...
        field :access_policy, Crystalline::Nilable.new(Models::Operations::GetPlaybackIdAccessPolicy), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('accessPolicy'), 'decoder': Utils.enum_from_string(Models::Operations::GetPlaybackIdAccessPolicy, true) } }
