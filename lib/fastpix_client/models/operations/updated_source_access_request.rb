  ...
  module Models
    module Operations
      ...
      class UpdatedSourceAccessRequest
        ...
        field :body, Models::Operations::UpdatedSourceAccessRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, body: Models::Operations::UpdatedSourceAccessRequestBody).void }
