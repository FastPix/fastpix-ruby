  ...
  module Models
    module Operations
      ...
      class CreateMediaPlaybackIdAccessRestrictions
        ...
        field :domains, Crystalline::Nilable.new(Models::Components::DomainRestrictions), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('domains') } }
        # Restrictions based on the user agent
        field :user_agents, Crystalline::Nilable.new(Models::Components::UserAgentRestrictions), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('userAgents') } }
