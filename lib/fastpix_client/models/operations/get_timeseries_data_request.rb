  ...
  module Models
    module Operations
      ...
      class GetTimeseriesDataRequest
        ...
        # 
        field :timespan, Crystalline::Nilable.new(Models::Operations::GetTimeseriesDataTimespan), { 'query_param': { 'field_name': 'timespan[]', 'style': 'form', 'explode': true } }
        ...
        sig { params(metric_id: Models::Operations::GetTimeseriesDataMetricId, timespan: T.nilable(Models::Operations::GetTimeseriesDataTimespan), filterby: T.nilable(::String), group_by: T.nilable(Models::Operations::GroupBy), sort_order: T.nilable(Models::Operations::GetTimeseriesDataSortOrder), measurement: T.nilable(::String)).void }
        def initialize(metric_id:, timespan: nil, filterby: nil, group_by: Models::Operations::GroupBy::MINUTE, sort_order: Models::Operations::GetTimeseriesDataSortOrder::ASC, measurement: 'avg')
          @metric_id = metric_id
          @timespan = timespan
          @filterby = filterby
          @group_by = group_by
