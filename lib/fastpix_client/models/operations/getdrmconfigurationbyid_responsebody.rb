  ...
  module Models
    module Operations
      ...
      class GetDrmConfigurationByIdResponseBody
        ...
        field :data, Crystalline::Nilable.new(Models::Components::DrmIdResponse), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }

        sig { params(success: T.nilable(T::Boolean), data: T.nilable(Models::Components::DrmIdResponse)).void }
