  ...
  module Models
    module Operations
      ...
      class ListFilterValuesForDimensionResponseBody
        ...
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::BrowserNameDimensiondetails)), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }
