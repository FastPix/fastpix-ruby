  ...
  module Models
    module Operations
      ...
      class CreatePlaybackIdOfStreamRequest
        ...
        field :body, Models::Components::PlaybackIdRequest, { 'request': { 'media_type': 'application/json' } }

        sig { params(stream_id: ::String, body: Models::Components::PlaybackIdRequest).void }
