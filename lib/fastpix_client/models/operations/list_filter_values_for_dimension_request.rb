  ...
  module Models
    module Operations
      ...
      class ListFilterValuesForDimensionRequest
        ...
        # 
        field :timespan, Crystalline::Nilable.new(Models::Operations::ListFilterValuesForDimensionTimespan), { 'query_param': { 'field_name': 'timespan[]', 'style': 'form', 'explode': true } }
        ...
        sig { params(dimensions_id: Models::Operations::DimensionsId, timespan: T.nilable(Models::Operations::ListFilterValuesForDimensionTimespan), filterby: T.nilable(::String)).void }
        def initialize(dimensions_id:, timespan: nil, filterby: nil)
