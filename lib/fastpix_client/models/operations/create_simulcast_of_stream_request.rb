  ...
  module Models
    module Operations
      ...
      class CreateSimulcastOfStreamRequest
        ...
        field :body, Models::Components::SimulcastRequest, { 'request': { 'media_type': 'application/json' } }

        sig { params(stream_id: ::String, body: Models::Components::SimulcastRequest).void }
