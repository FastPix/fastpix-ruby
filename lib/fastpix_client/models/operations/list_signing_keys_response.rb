  ...
  module Models
    module Operations
      ...
      class ListSigningKeysResponse
        ...
        def initialize(content_type:, status_code:, raw_response:, get_all_signing_keys_response: nil, default_error: nil)
          @content_type = content_type
          @status_code = status_code
          @raw_response = raw_response
          @get_all_signing_keys_response = get_all_signing_keys_response
        ...
        def ==(other)
          ...
          return false unless @get_all_signing_keys_response == other.get_all_signing_keys_response
