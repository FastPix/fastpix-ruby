  ...
  module Models
    module Operations
      ...
      class UpdateAPlaylistRequest
        ...
        field :body, Models::Components::UpdatePlaylistRequest, { 'request': { 'media_type': 'application/json' } }

        sig { params(playlist_id: ::String, body: Models::Components::UpdatePlaylistRequest).void }
