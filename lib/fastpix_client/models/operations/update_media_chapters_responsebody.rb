  ...
  module Models
    module Operations
      ...
      class UpdateMediaChaptersResponseBody
        ...
        field :data, Crystalline::Nilable.new(Models::Components::ChaptersResponse), { 'format_json': { 'letter_case': ::FastpixClient::Utils.field_name('data') } }

        sig { params(success: T.nilable(T::Boolean), data: T.nilable(Models::Components::ChaptersResponse)).void }
