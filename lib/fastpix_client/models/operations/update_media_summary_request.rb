  ...
  module Models
    module Operations
      ...
      class UpdateMediaSummaryRequest
        ...
        field :body, Models::Operations::UpdateMediaSummaryRequestBody, { 'request': { 'media_type': 'application/json' } }

        sig { params(media_id: ::String, body: Models::Operations::UpdateMediaSummaryRequestBody).void }
