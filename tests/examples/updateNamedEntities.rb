...
res = s.in_video_ai_features.update_media_named_entities(media_id: 'f7253f80-af5c-4eb7-9cc7-cd04b7877ff4', body: Models::Operations::UpdateMediaNamedEntitiesRequestBody.new(
  named_entities: true,
))
